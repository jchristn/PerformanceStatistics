...
namespace PerformanceStatistics.Linux
{
    ...
    /// </summary>
    public class LinuxPerformanceStatistics : IPerformanceStatistics
    {
        ...
        /// </summary>
        public ISystemCounters System { get; } = new LinuxSystemCounters();
                    ...
                    if (_monitoredProcessNames != null && _monitoredProcessNames.Count > 0)
                    {
                        foreach (string processName in _monitoredProcessNames)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    counters.Add(new LinuxProcessCounters(process));
                                }
        ...
        public LinuxPerformanceStatistics(List<string> monitoredProcesses = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append(((LinuxSystemCounters)System).ToString());
